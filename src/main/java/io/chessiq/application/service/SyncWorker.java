...
public class SyncWorker {
    ...
    public SyncWorker(PlayerRepository playerRepository,
    ...
    // No currentUserId here — entitlement was settled at the door.
    @Async
    public void doSync(PlayerEntity player) {
        String username = player.getChessComUsername();
